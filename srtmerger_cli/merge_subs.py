...
def merge_subs(
    upper_sub: Path, lower_sub: Path, *, upper_yellow: bool = False, lower_yellow: bool = False, output: Optional[Path] = None
) -> None:
    ...
    m.add(str(upper_sub), color=Colors.YELLOW if upper_yellow else Colors.WHITE, top=True)
